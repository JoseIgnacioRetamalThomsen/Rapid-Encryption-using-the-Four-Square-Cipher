...
public class EncryptionA implements Runnable
{
	 ...
	 * m*encryptLine()Time have a relevant value , because m*encryptLine()Time= 0.0650893 seconds.
	 * 
	 ...
	 * sapaceUsed =  39,311 Bytes+ 10,000*1,434 bytes. = 14,379,311 bytes
	 */
	@Override
	public void run()
	{
	 ...
	 */
	/*
	 * Big-O: Time (9) : O(a) ( a=lineEncryptp.length() ).
	 * 
	 * Estimation (10) : T(n) =25n +5 , n = average number of characters per line , for
	 * the "WarAndPeace-LeoTolstoy" , n=80 and at 2 billion computation per second
	 * (25*80 + 5)/(2*10^9)= 1.0025 *10^(-6) second
	 * 
	 * Big-O: Space (11): O(a) ( a=lineEncryptp.length() ).
	 * 
	* Estimation (12): 2*char + 7*int + 1*boolean + 4a + (the 4 arrays of chars) = 2*2
	 ...
	 * 
	 * Estimation A 2D char array = (16 +2n)^2 = 4n^2 + 64 n + 256 , n = r=91 = 'Z'+1, plus
	 * 4 *int , -> 4*91*91 + 65*91 +256 +4*4 = 39,311 Bytes
	 */
